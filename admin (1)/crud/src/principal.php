...
$query2 = mysqli_query($conexion, "SELECT COUNT(ClienteID) AS total FROM cliente ");
$totalClientes = mysqli_fetch_assoc($query2);
$query3 = mysqli_query($conexion, "SELECT COUNT(ReservaID) AS total FROM reserva ");
$totalProductos = mysqli_fetch_assoc($query3);
$query4 = mysqli_query($conexion, "SELECT COUNT(ContactoID) AS total FROM contacto ");
$totalCategorias = mysqli_fetch_assoc($query4);
$query4 = mysqli_query($conexion, "SELECT COUNT(PagoID) AS total FROM pago ");
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    ...
                    <a href="reservas.php" class="small-box-footer">Mas info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    ...
                    <a href="pagos.php" class="small-box-footer">Mas info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
